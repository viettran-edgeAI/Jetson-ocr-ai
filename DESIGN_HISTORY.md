...
| 2026-05-20 | Tuned `llm-service` for one-shot OCR QA with a 4096-token context, capped OCR prompt text, explicit Gemma no-thinking flags, container health checks, and unit/smoke tests. | The LLM service should answer short grounded requests without allocating a large context window or spending tokens on hidden reasoning. |
